...
export default function FlotteAvecChauffeurPage() {
  ...
  // Filtrer les véhicules pour la page "Avec chauffeur"
  // Mercedes Classe S, Mercedes Classe V, Mercedes Sprinter, Range Rover Vogue, Range Rover Defender
